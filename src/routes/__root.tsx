    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-5">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-full bg-primary px-5 py-2.5 text-sm font-semibold text-primary-foreground ring-1 ring-primary-deep/40"
          >
            Go home
          </Link>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Promptcraft — AI Prompts Built for Real Problems" },
      {
        name: "description",
        content:
          "Specialized AI prompt toolkits for scholarship applicants, students, job seekers and developers. Fill in your details and get a customized prompt.",
      },
